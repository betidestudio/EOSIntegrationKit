...
public:
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_AcceptConnection(const FEIK_ProductUserId& LocalUserId, const FEIK_ProductUserId& RemoteUserId, FEIK_P2P_SocketId SocketId);
	...
	const FEIK_NotificationId EIK_P2P_AddNotifyIncomingPacketQueueFull(const FEIK_ProductUserId& LocalUserId, const FEIK_P2P_SocketId SocketId, const FEIK_OnIncomingPacketQueueFull& Callback);
	...
	const FEIK_NotificationId EIK_P2P_AddNotifyPeerConnectionClosed(const FEIK_ProductUserId& LocalUserId, const FEIK_P2P_SocketId SocketId, const FEIK_OnPeerConnectionClosed& Callback);
	...
	const FEIK_NotificationId EIK_P2P_AddNotifyPeerConnectionEstablished(const FEIK_ProductUserId& LocalUserId, const FEIK_P2P_SocketId SocketId, const FEIK_OnPeerConnectionEstablished& Callback);
	...
	const FEIK_NotificationId EIK_P2P_AddNotifyPeerConnectionInterrupted(const FEIK_ProductUserId& LocalUserId, const FEIK_P2P_SocketId SocketId, const FEIK_OnPeerConnectionInterrupted& Callback);
	...
	const FEIK_NotificationId EIK_P2P_AddNotifyPeerConnectionRequest(const FEIK_ProductUserId& LocalUserId, const FEIK_P2P_SocketId SocketId, const FEIK_OnIncomingConnectionRequest& Callback);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_ClearPacketQueue(const FEIK_ProductUserId& LocalUserId, const FEIK_ProductUserId& RemoteUserId, FEIK_P2P_SocketId SocketId);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_CloseConnection(const FEIK_ProductUserId& LocalUserId, const FEIK_ProductUserId& RemoteUserId, FEIK_P2P_SocketId SocketId);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_CloseConnections(const FEIK_ProductUserId& LocalUserId, FEIK_P2P_SocketId SocketId);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_GetNextReceivedPacketSize(const FEIK_ProductUserId& LocalUserId, int32 Channel, int32& OutPacketSizeBytes);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_ReceivePacket(const FEIK_ProductUserId& LocalUserId, int32 MaxDataSizeBytes, int32 RequestedChannel, FEIK_P2P_SocketId& OutSocketId, FEIK_ProductUserId& OutPeerId, int32& OutChannel, TArray<uint8>& OutData, int32& OutBytesRead);
	...
	static const TEnumAsByte<EEIK_Result> EIK_P2P_SendPacket(const FEIK_ProductUserId& LocalUserId, const FEIK_ProductUserId& RemoteUserId, FEIK_P2P_SocketId SocketId, int32 Channel, const TArray<uint8>& Data, bool bAllowDelayedDelivery, bool bDisableAutoAcceptConnection, const TEnumAsByte<EEIK_EPacketReliability>& Reliability);
