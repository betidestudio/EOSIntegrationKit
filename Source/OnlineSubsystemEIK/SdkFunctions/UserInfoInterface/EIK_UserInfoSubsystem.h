...
class ONLINESUBSYSTEMEIK_API UEIK_UserInfoSubsystem : public UGameInstanceSubsystem
{
	...
	*EOS_UserInfo_CopyBestDisplayName is used to immediately retrieve a copy of user's best display name based on an Epic Account ID. This uses data cached by a previous call to EOS_UserInfo_QueryUserInfo, EOS_UserInfo_QueryUserInfoByDisplayName or EOS_UserInfo_QueryUserInfoByExternalAccount as well as EOS_Connect_QueryExternalAccountMappings. If the call returns an EOS_Success result, the out parameter, OutBestDisplayName, must be passed to EOS_UserInfo_BestDisplayName_Release to release the memory associated with it.
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyBestDisplayName(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, FEIK_UserInfo_BestDisplayName& OutBestDisplayName);
	...
	*EOS_UserInfo_CopyBestDisplayNameWithPlatform is used to immediately retrieve a copy of user's best display name based on an Epic Account ID. This uses data cached by a previous call to EOS_UserInfo_QueryUserInfo, EOS_UserInfo_QueryUserInfoByDisplayName or EOS_UserInfo_QueryUserInfoByExternalAccount. If the call returns an EOS_Success result, the out parameter, OutBestDisplayName, must be passed to EOS_UserInfo_BestDisplayName_Release to release the memory associated with it.
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyBestDisplayNameWithPlatform(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, const int32& Platform, FEIK_UserInfo_BestDisplayName& OutBestDisplayName);
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyExternalUserInfoByAccountId(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, FString AccountId, FEIK_UserInfo_ExternalUserInfo& OutExternalUserInfo);
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyExternalUserInfoByAccountType(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, const TEnumAsByte<EEIK_EExternalAccountType>& AccountType, FEIK_UserInfo_ExternalUserInfo& OutExternalUserInfo);
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyExternalUserInfoByIndex(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, const int32& Index, FEIK_UserInfo_ExternalUserInfo& OutExternalUserInfo);
	...
	static TEnumAsByte<EEIK_Result> EIK_UserInfo_CopyUserInfo(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId, FEIK_UserInfo& OutUserInfo);
	...
	static int32 EIK_UserInfo_GetExternalUserInfoCount(const FEIK_EpicAccountId& LocalUserId, const FEIK_EpicAccountId& TargetUserId);
