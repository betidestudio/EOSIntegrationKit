...
public:
	...
	static TEnumAsByte<EEIK_Result> EIK_Stats_CopyStatByIndex(const FEIK_ProductUserId& TargetUserId, int32 StatIndex, FEIK_Stats_Stat& OutStat);
	...
	static TEnumAsByte<EEIK_Result> EIK_Stats_CopyStatByName(const FEIK_ProductUserId& TargetUserId, const FString& Name, FEIK_Stats_Stat& OutStat);
	...
	static int32 EIK_Stats_GetStatsCount(const FEIK_ProductUserId& TargetUserId);
