...
void FOnlineSubsystemEOSModule::StartupModule()
{
	...
	PluginCommands->MapAction(
		...
		FExecuteAction::CreateRaw(this, &FOnlineSubsystemEOSModule::PluginButtonClicked),
		FCanExecuteAction());

#if WITH_EDITOR
	UToolMenus::RegisterStartupCallback(FSimpleMulticastDelegate::FDelegate::CreateRaw(this, &FOnlineSubsystemEOSModule::RegisterMenus));
#endif
#if WITH_EDITOR
...
void FOnlineSubsystemEOSModule::PluginButtonClicked()
{
#if WITH_EDITOR
...
void FOnlineSubsystemEOSModule::RegisterMenus()
{
#if WITH_EDITOR
